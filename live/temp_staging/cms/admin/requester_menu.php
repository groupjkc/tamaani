          ...
          <td>
            ...
            <tr class="tcat">
              ...
              <td>
               ...
               <td>
                <a href="<?php echo $p->makelink('TimeUpdateTeam', $p->courent)?>" class="text">
                 Last Tamaani Team Mod
                  </a>
              </td>
               
               <td>
                <a href="<?php echo $p->makelink('TimeUpdateRequester', $p->courent)?>" class="text">
                 Last Requester Mod
                  </a>
              </td>
                  
               <td>
                <a href="<?php echo $p->makelink('TimeUpdateSites', $p->courent)?>" class="text">
                  Last Sites Mod
                 </a>
              </td>       
	        ...
	        <?php
	          ...
	          while($row=@mysql_fetch_array($res))
	          {
				...
				$TimeUpdateTeam         = ($row['TimeUpdateTeam']!='0000-00-00 00:00:00') ? $row['TimeUpdateTeam'] :''; 
				$TimeUpdateRequester   = ($row['TimeUpdateRequester']!='0000-00-00 00:00:00') ? $row['TimeUpdateRequester'] :'';
				$TimeUpdateSites       = ($row['TimeUpdateSites']!='0000-00-00 00:00:00') ? $row['TimeUpdateSites'] :''; 
		    ...
		    <tr bgcolor="<?php echo $color?>" id         = "<?php echo $i?>"
              ...
              <td align="center">
                ...
                <?php } ?>
                  ...
                  <td>
                  <?php echo $TimeUpdateTeam ?>
                </td>  
                 <td>
                  <?php echo $TimeUpdateRequester ?>
                </td>  
               
                
                <td>
                  <?php echo $TimeUpdateSites ?>
                </td>   
