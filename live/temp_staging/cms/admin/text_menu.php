...
<?php 
   //---> Rubrique valide ?
   $rubrique_id = getRubriqueId("text");
 ...
 //  include "include/pagination.php";       //---> Utiliser le module pagination	
   ...
   {
	 text_supprimer($_POST['supprimer']);
   } //Fsi
  ...
  **********************************************************************************************************/
  ...
  $p = new CAdminPagination("text","", 10, "title_en");
...
<!--
  ...
  function ajouter()
  {
    popup('text_add.php?session=<?php echo $session?>&lang=<?php echo $lang?>',525,350);
  } //Fin ajouter
-->
</script>
          ...
          <?php 
		    ...
		    <tr bgcolor="<?php echo $color?>" id         = "<?php echo $i?>"
              ...
              <td height="25" align="left" class="inactif">
				...
				<input type="hidden" name="id[]" value="<?php echo $row['text_id']?>">
			  </td>
              <td>
                <?php 
				if($mod=='Y') 
		        {
		      ?>
                <a href="javascript:popup_scroll('text_add.php?session=<?php echo $session?>&lang=<?php echo $lang?>&text_id=<?php echo $row['text_id']?>',900,3000);" class="menutext">
              ...
              <td width="85" valign="middle" align="center">
                <img src="../../images/<?php echo $text_icon?>" alt="<?php echo $title_en?>" width="75" height="75" border="0" align="absmiddle">
              </td>
            </tr>
			<?php
			  } //FTQ
