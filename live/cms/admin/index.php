...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td  bgcolor="#EAEEEE" height="25" valign="middle" onmouseover="this.style.background='#DDEEFF'" onmouseout="this.style.background='#EAEEEE'">
      &nbsp;&nbsp;
      <a href="./?<?php echo $action?>=tenyears&session=<?php echo $session?>&lang=<?php echo $lang?>" class="menutext">
        ABOUT US SubTexts</a></td>   
  ...
  <tr class="2">
    ...
    ?>
		...
		<tr>
          <td bgcolor="#EAEEEE" height="25" valign="middle" onmouseover="this.style.background='#DDEEFF'" onmouseout="this.style.background='#EAEEEE'">
            &nbsp;&nbsp;
            <a href="./?<?php echo $action?>=forms&session=<?php echo $session?>&lang=<?php echo $lang?>" class="menutext">
              Forms            </a>          </td>
          <td bgcolor="#7A7B7B"></td>
        </tr>
		<tr class="2">
		...
		<tr>
          <td bgcolor="#EAEEEE" height="25" valign="middle" onmouseover="this.style.background='#DDEEFF'" onmouseout="this.style.background='#EAEEEE'">
            &nbsp;&nbsp;
            <a href="./?<?php echo $action?>=background&session=<?php echo $session?>&lang=<?php echo $lang?>" class="menutext">
              Background            </a>          </td>
          <td bgcolor="#7A7B7B"></td>
        </tr>
