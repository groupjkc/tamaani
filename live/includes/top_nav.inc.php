<?php	
    ...
    <?php
    	$sub_menu = get_tenYears_links();
    	$title_lang = "title_" . $_SESSION['lang'];
    	$sub_menu_str = "";
    	foreach ($sub_menu as $sm) {
    		$sub_menu_str .= "<li><a id='".$sm["id"]."' title='".$sm[$title_lang]."'  href='#company-page-".$sm["id"]."' class='clicked sub_about_child' data-id='".$sm["id"]."'>".$sm[$title_lang]."</a></li>";
    	}
    ?>
    ...
    echo   "<div id='top_nav_wrapper'> 
		<div id='top_nav'>
            <div id='top_nav_menu' >
                <ul>
					<li>
						<a title='".$lang['company']."'   class='clicked' id='about_us'>".$lang['company']."</a>
						<ul id='sub_about'>
							<!--<li><a  title='10 years anniversary'  href='#tenyears_page' class='clicked' id='tenyears'>10 years anniversary</a></li>-->
							".$sub_menu_str."
						</ul>
					</li>
