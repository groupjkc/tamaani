...
switch($_GET[$action])
{
	...
	case "text" : $rubrique = "text";
		...
		break;
	case "forms" : $rubrique = "forms";
		$include_filename = "forms_menu.php";
		break;	
	case "background" : $rubrique = "background";
		$include_filename = "background_menu.php";
		break;
	case "tenyears" : $rubrique = "tenyears";
		$include_filename = "tenyears_menu.php";
		break;
