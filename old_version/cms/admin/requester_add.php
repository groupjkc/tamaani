                ...
                <tr align="left">
                  ...
                  <td align="left" class="menutext">
                   ...
                   <tr align="left">
                    ...
                    <tr align="left">
                     ...
                     Special Needs
                      ...
                      <td align="left" class="menutext">
                        <input name="SpecialNeeds" type="text" class='zone' id="SpecialNeeds" style="width:90%;" value="<?php echo $SpecialNeeds?>">
                      </td>
                    </tr>
                    ...
                    <tr align="left">
                      ...
                      <td align="left" class="menutext">
                        <input name="FirstTimeUser" type="text" class='zone' id="FirstTimeUser" style="width:90%;" value="<?php echo $FirstTimeUser?>">
                      </td>
                    </tr>
                     ...
                     <tr align="left">
                      ...
                      <td align="left" class="menutext">
                        <input name="RequireTraining" type="text" class='zone' id="RequireTraining" style="width:90%;" value="<?php echo $RequireTraining?>">
                      </td>
                    </tr>                                       
                   ...
                   <?php  
				         ...
				         $site = "SELECT  	* FROM   requester_site JOIN site on  requester_site.site_id = site.site_id  where  requester_id= ".$requester_id ;
