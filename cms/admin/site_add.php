  ...
  if (!isset($_GET['session'])) {
    ...
    if (isset($_POST['SiteName'])) {
      include './include/operation_message.php';
				...
				$Equipment     = lecture($_POST['Equipment']);
				$Model         = lecture($_POST['Model']);
    ...
    if (isset($_GET['site_id'])) {
      ...
      if ($row == FALSE) {
		...
		$Equipment       =  decode_text($row['Equipment']);
		$Model           =  decode_text($row['Model']);		
                        ...
                        <tr align="left">
                         ...
                         <tr align="left">
                            ...
                            <tr align="left">
                              ...
                              <td align="left" class="menutext">
                                <input name="Equipment" type="text" class='zone' id="Equipment" style="width:90%;" value="<?php echo $Equipment?>">
                              </td>
                            </tr>    
                            ...
                            <tr align="left">
                              ...
                              <td align="left" class="menutext">
                                <input name="Model" type="text" class='zone' id="Model" style="width:90%;" value="<?php echo $Model?>">
                              </td>
                            </tr>   
