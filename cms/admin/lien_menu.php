...
<?php 
   //---> Rubrique valide ?
   $rubrique_id = getRubriqueId("lien");
 ...
 //  include "include/pagination.php";       //---> Utiliser le module pagination	
   ...
   {
	 lien_supprimer($_POST['supprimer']);
   } //Fsi
   ...
   if (isset($_POST['id']))
   {
     ...
     if (isset($_POST['visible']))
	   lien_visible($_POST['visible'],$_POST['id']);
	 else
	   lien_visible(NULL,$_POST['id']);  // Tous à faux
   } //Fsi
  ...
  **********************************************************************************************************/
  ...
  $p = new CAdminPagination("lien","", 10, "title_en");
...
<!--
  ...
  function ajouter()
  {
    popup('lien_add.php?session=<?php echo $session?>&lang=<?php echo $lang?>',525,350);
  } //Fin ajouter
-->
</script>
	  ...
	  <td>
        ...
        <tr>
          ...
          <?php 
	          ...
	          ?>
              <td width="40">
				<a href="<?php echo $p->makelink('lien_visible', $p->courent)?>" class="text">
	              Visible
				</a>			    
			  </td>
	          <?php
	        ...
	        <?php
	          ...
	          while($row=@mysql_fetch_array($res))
	          {
				...
				$url       = affichage($row['lien_url'],"---");				
				$lien_visible = ($row['lien_visible']=='Y')? "CHECKED" : "";
		    ...
		    <tr bgcolor="<?php echo $color?>" id         = "<?php echo $i?>"
              ...
              <td height="25" align="left" class="inactif">
				...
				<input type="hidden" name="id[]" value="<?php echo $row['lien_id']?>">
			  </td>
              <td>
                <?php 
				if($mod=='Y') 
		        {
		      ?>
                <a href="javascript:popup('lien_add.php?session=<?php echo $session?>&lang=<?php echo $lang?>&lien_id=<?php echo $row['lien_id']?>',525,350);" class="menutext">
                  <?php echo $title_en?>
                  </a>
                <?php
				} else 
			  ...
			  <td width="85" valign="middle" align="center">
			    <img src="../../images/links/<?php echo $lien_icon?>" alt="Photo actualite" width="75" height="75" border="0" align="absmiddle">
			  </td>
			  <?php 
			    if($mod=='Y') 
		        {   
              ...
              <td align="center">
				<input type="Checkbox" name="visible[]" value="<?php echo $row['lien_id']?>" style="color:#666666;" <?php echo $lien_visible?> >
			  </td>
			  <?php
			    } //Fsi
	          ...
	          ?>			  
              <td align="center">
				<input type="Checkbox" name="supprimer[]" id="supprimer<?php echo $i?>" value="<?php echo $row['lien_id']?>"  onClick="javascript: restore_row(this.parentNode.parentNode, '<?php echo $color?>');" >
			  </td>
			  <?php
			    } //Fsi
			  ?>
