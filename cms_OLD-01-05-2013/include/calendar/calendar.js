...
//        email :        fuushikaden@yahoo.com
        ...
        var imgDir = "./include/calendar/"        // directory for images ... e.g. var imgDir="/img/"

        var gotoString = "Aller au mois courant"
        var todayString = "" //"Nous sommes le"
        var weekString = "Wk"
        var scrollLeftMessage = "Cliquez pour faire défiler au mois précédent. Maintenez le bouton de la souris pour faire défiler automatiquement.."
        var scrollRightMessage = "Cliquez pour faire défiler le mois prochain. Maintenez le bouton de la souris pour faire défiler automatiquement."
        var selectMonthMessage = "Cliquez pour choisir un mois."
        var selectYearMessage = "Cliquez pour choisir une année."
        var selectDateMessage = "Choisissez [date] comme  date." // do not replace [date], it will be replaced by date.
        ...
        var        imgsrc = new Array("suivant.gif","suivant_color.gif","precedent.gif","precedent_color.gif","suivant.gif","suivant_color.gif")
        var        img        = new Array()
      ...
      if( ie )
      {
        ...
        function init()        {
                if (!ns4)
                {
                        ...
                        sHTML1= "<span id='spanLeft'  class='title-control-normal-style' onmouseover='swapImage(\"changeLeft\",\"precedent_color.gif\");this.className=\"title-control-select-style\";window.status=\""+scrollLeftMessage+"\"' onclick='javascript:decMonth()' onmouseout='clearInterval(intervalID1);swapImage(\"changeLeft\",\"precedent.gif\");this.className=\"title-control-normal-style\";window.status=\"\"' onmousedown='clearTimeout(timeoutID1);timeoutID1=setTimeout(\"StartDecMonth()\",500)'        onmouseup='clearTimeout(timeoutID1);clearInterval(intervalID1)'>&nbsp<IMG id='changeLeft' SRC='"+imgDir+"precedent.gif' width=10 height=11 BORDER=0>&nbsp</span>&nbsp;"
                        sHTML1+="<span id='spanRight' class='title-control-normal-style' onmouseover='swapImage(\"changeRight\",\"suivant_color.gif\");this.className=\"title-control-select-style\";window.status=\""+scrollRightMessage+"\"' onmouseout='clearInterval(intervalID1);swapImage(\"changeRight\",\"suivant.gif\");this.className=\"title-control-normal-style\";window.status=\"\"' onclick='incMonth()' onmousedown='clearTimeout(timeoutID1);timeoutID1=setTimeout(\"StartIncMonth()\",500)'        onmouseup='clearTimeout(timeoutID1);clearInterval(intervalID1)'>&nbsp<IMG id='changeRight' SRC='"+imgDir+"suivant.gif'        width=10 height=11 BORDER=0>&nbsp</span>&nbsp"
                        sHTML1+="<span id='spanMonth' class='title-control-normal-style' onmouseover='swapImage(\"changeMonth\",\"suivant_color.gif\");this.className=\"title-control-select-style\";window.status=\""+selectMonthMessage+"\"' onmouseout='swapImage(\"changeMonth\",\"suivant.gif\");this.className=\"title-control-normal-style\";window.status=\"\"' onclick='popUpMonth()'></span>&nbsp;"
                        sHTML1+="<span id='spanYear'  class='title-control-normal-style' onmouseover='swapImage(\"changeYear\",\"suivant_color.gif\");this.className=\"title-control-select-style\";window.status=\""+selectYearMessage+"\"'        onmouseout='swapImage(\"changeYear\",\"suivant.gif\");this.className=\"title-control-normal-style\";window.status=\"\"'        onclick='popUpYear()'></span>&nbsp;"
        ...
        function WeekNbr(today)
    {
        ...
        function constructCalendar () {
                ...
                for        ( datePointer=1; datePointer<=numDaysInMonth; datePointer++ )
                {
                   ...
                   //    alpha2=constructDate(datePointer,monthSelected,yearSelected)
                   //       courant.setDate(alpha2);
                 //       tmp=dayName[(courant.getDay()-startAt==-1)?6:(courant.getDay()-startAt)];
                      // WeekNbr(tmp) ;
                 //    alert(tmp);
               //     if (JsVars[tmp]==1)
                ...
                //     else
                //        sHTML += "<span  class='"+sStyle+"' "+dateMessage+" title=\"" + sHint + "\" href='javascript:dateSelected="+datePointer+";closeCalendar();'>&nbsp;" + datePointer + "&nbsp;</span>"
                ...
                document.getElementById("spanMonth").innerHTML = "&nbsp;" +        monthName[monthSelected] + "&nbsp;<IMG id='changeMonth' SRC='"+imgDir+"suivant.gif' WIDTH='12' HEIGHT='10' BORDER=0>"
                document.getElementById("spanYear").innerHTML =        "&nbsp;" + yearSelected        + "&nbsp;<IMG id='changeYear' SRC='"+imgDir+"suivant.gif' WIDTH='12' HEIGHT='10' BORDER=0>"
        }
