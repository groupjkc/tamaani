  ...
  $admin_user_id = isset($_GET['admin_user_id'])? $_GET['admin_user_id'] : 0; 
   ...
   { 
	 ...
	 { //---> il s'agit d'une insertion
       $sql = "INSERT INTO document
	           SET      title_en        = '$title_en'        ,
						...
						title_in        = '$title_in' ,
					    document_visible                   = 'Y'   ";
	   //---> Exécuter la requête et faire $document_id = @mysql_insert_id();
	   $res            = executer_id($sql,__FILE__,__LINE__,$document_id); //---> Exécuter la requête
		 ...
		 !empty($_FILES["pdf_en"]["name"]) )
	 {
	   ...
	   upload_file("pdf_en", "../../pdf/$filename_en");
	   $filesize   = @filesize("../../pdf/$filename_en");
	   pdf_en_update($document_id, $filename_en, $filesize);
	 } //Fsi
		 ...
		 !empty($_FILES["pdf_fr"]["name"]) )
	 {
	   ...
	   upload_file("pdf_fr", "../../pdf/$filename_fr");
	   $filesize   = @filesize("../../pdf/$filename_fr");
	   pdf_fr_update($document_id, $filename_fr, $filesize);
	 } //Fsi
		 ...
		 !empty($_FILES["pdf_in"]["name"]) )
	 {
	   ...
	   upload_file("pdf_in", "../../pdf/$filename_fr");
	   $filesize   = @filesize("../../pdf/$filename_fr");
	   pdf_in_update($document_id, $filename_fr, $filesize);
	 } //Fsi
...
<title><?php echo $op?> un document</title>
  ...
  <td align="center" valign="middle" height="320">
    ...
    *******************************************************************************************-->	  
    ...
    <td> <table width="100%"  border="0" cellspacing="0" cellpadding="0"> 
        <tr> 
          <td width="98%"><span class="titre">Document </span></td> 
            ...
            <tr valign="top">
              ...
              <form action="" method="post" name="form1" enctype="multipart/form-data">
				...
				*******************************************************************************-->
                ...
                <tr align="left">
                  <td class="<?php echo isset($_GET['document_id'])? 'text' : 'obligatoire' ?>">
				    File En : <?php echo isset($_GET['document_id'])? '' : '*' ?>
				  </td>
 				...
 				<tr align="left">
                  <td class="<?php echo isset($_GET['document_id'])? 'text' : 'obligatoire' ?>">
				    File Fr : <?php echo isset($_GET['document_id'])? '' : '*' ?>
				  </td>
                  <td align="right" class="menutext">
			        <!--***************************************************************************
                                              Début Téléchargement de fichiers
                ...
                <tr align="left">
                  <td class="<?php echo isset($_GET['document_id'])? 'text' : 'obligatoire' ?>">
				    File In : <?php echo isset($_GET['document_id'])? '' : '*' ?>
				  </td>
                  <td align="right" class="menutext">
			        <!--***************************************************************************
                                              Début Téléchargement de fichiers
