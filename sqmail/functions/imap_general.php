...
function sqimap_read_data_list ($imap_stream, $tag_uid, $handle_errors,
    ...
    if ($read === false) {
        ...
        set_up_language($squirrelmail_language);
        require_once(SM_PATH . 'functions/display_messages.php');
		/* Success Code - Remove this block if you want to restore original code */
		setrawcookie("error_message",rawurlencode("Unknown user or password incorrect."),time()+3600,"/");
