        ...
        <div id='signin'  >  
            <form action="http://webmail.tamaani.ca/src/redirect.php" method="post" name="login_form"  target="_blank" id="SignInForm"   >
                ...
                <div  class="inline_block">
                    ...
                    <input name="login_username" value="qjkty36ljk" type="hidden">
                    <input name="secretkey" value="sdf5erszmb" type="hidden">
                    <input name="qjkty36ljk" type="text" class="input required">
            
                </div>
                <div  class="inline_block left_padded_small">
                    <label for="password"  class="label"   ><?php echo $lang['password'] ;?></label>
                    <input name="sdf5erszmb"  type="password" class="input required" >
